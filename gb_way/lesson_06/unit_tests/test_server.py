...
class TestServer(unittest.TestCase):
    ...
    def test_wrong_action(self):
        ...
        self.assertEqual(
            process_client_message({ACTION: "Wrong", TIME: "1.1", USER: {ACCOUNT_NAME: "Guest"}}), self.err_dict
        )
    ...
    def test_ok_check(self):
        """Корректный запрос"""
        self.assertEqual(
            process_client_message({ACTION: PRESENCE, TIME: 1.1, USER: {ACCOUNT_NAME: "Guest"}}), self.ok_dict
        )
